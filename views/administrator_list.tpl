{include file="views/header.tpl"}{assign name="title" value="Liste des administrateurs" /}{/include}
{include file="views/menu.tpl"}{assign name="is_list_administrators" value="True"/}{/include}
	<div class="container">
